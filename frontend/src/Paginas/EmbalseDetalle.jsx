...
export default function EmbalseDetalle(){
  ...
  useEffect(() => {
    if (!embalse) return
    fetch(`https://octopus-app-p7ahd.ondigitalocean.app/embalses/${embalse.dbId}`)  
      .then(r => r.json())
      .then(d =>
        setDatosEmbalse({
  ...
  useEffect(() => {
    if (!embalse) return
    fetch(`https://octopus-app-p7ahd.ondigitalocean.app/embalses/tiempo/${embalse.dbId}`)
      .then(r => r.json())
      .then(d => {
  ...
  useEffect(() => {
    if (!embalse) return
    fetch(`https://octopus-app-p7ahd.ondigitalocean.app/embalses/${embalse.dbId}/mapa`)
      .then(r => r.json())
  ...
  <div className="tarjeta-container">
    ...
    <div className="tarjeta-embalse">
      ...
      <div className="info-item">
        ...
        <strong>Uso principal:</strong> {uso}
      </div>
